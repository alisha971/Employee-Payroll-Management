...
const PositionData = () => {
    ...
    return (
        <Layout>
            ...
            <Link to="/position-data/form-position-data/add" >
                <ButtonOne  >
                                        ...
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <div className='flex items-center space-x-3.5'>
                                                <Link
                                                    ...
                                                    to={`/position-data/form-position-data/edit/${data.id}`}
                                                >
                ...
                <div className="flex justify-between items-center mt-4 flex-col md:flex-row md:justify-between">
                    <div className="flex items-center space-x-2">
                        <span className="text-gray-5 dark:text-gray-4 text-sm py-4">
                            Displaying {startIndex + 1}-{Math.min(endIndex, filteredPositionData.length)} from {filteredPositionData.length} Position Data
                        </span>
                    </div>
