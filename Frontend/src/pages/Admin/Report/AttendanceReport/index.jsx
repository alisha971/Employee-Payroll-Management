...
import { fetchAttendanceReportByMonth, fetchAttendanceReportByYear, getMe } from '../../../../config/redux/action';
...
const AttendanceReport = () => {
    ...
    const handleSearch = async (event) => {
        ...
        await Promise.all([
            dispatch(fetchAttendanceReportByYear(selectedYear, () => (yearDataFound = true))),
            dispatch(fetchAttendanceReportByMonth(selectedMonth, () => (monthDataFound = true))),
        ]);
        setShowMessage(true);

        if (yearDataFound && monthDataFound) {
            setShowMessage(false);
            navigate(`/report/attendance/print-page?month=${selectedMonth}&year=${selectedYear}`);
        } else {
            setShowMessage(false);
            Swal.fire({
                icon: 'error',
