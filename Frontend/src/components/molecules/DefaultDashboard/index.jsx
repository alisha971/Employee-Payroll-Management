        ...
        const getEmployeeData = async () => {
            try {
                const response = await axios.get(
                    `http://localhost:5000/employee_data/name/${user.emp_name}`
                );
            ...
            {user && user.access_rights === "employee" && EmployeeData && (
                <>
                    <div className="mt-6">
                        ...
                        Welcome to MyPayroll. You are logged in as an employee.
                        </h2>
                    </div>
                        ...
                        <div className="md:w-2/3 px-4 md:px-20 py-4 md:py-20">
                            <div className="w-full md:text-lg">
                                ...
                                <h2 className="font-medium mb-4 block text-black dark:text-white">
                                    ...
                                    <span className="pl-[-10] md:pl-0"></span>{EmployeeData.emp_name}
                                </h2>
                                <h2 className="font-medium mb-4 block text-black dark:text-white">
