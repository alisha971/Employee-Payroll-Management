  ...
  return (
    <div className="parent flex min-h-[100vh] flex-col-reverse items-center justify-between pt-14 dark:bg-boxdark lg:flex-row ">
      ...
      >
        ...
        A company platform for efficiently managing employee payroll processes in an 
        integrated manner through a digital platform
        </p>
      ...
      >
        <div className="order-1  sm:pt-0 md:pt-0 lg:order-3 lg:pt-0">
          <img src={bannerImg} title="Banner" alt="Banner" />
        </div>
      </motion.div>
    </div>
  );
