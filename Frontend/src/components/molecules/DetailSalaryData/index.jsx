...
const DetailsalaryData = () => {
    ...
    const onSubmitPrint = () => {
        navigate(`/report/salary-slip/print-page?month=${data.month}&year=${data.year}&name=${name}`);
    };
    ...
    return (
        <Layout>
            <Breadcrumb pageName='Employee Salary Data Details' />
            <Link to='/salary-data'>
                <ButtonTwo>
                    <span>Back</span>
                </ButtonTwo>
                ...
                <div className='max-w-full overflow-x-auto'>
                    ...
                    <div className='w-full md:w-1/2 md:justify-end py-6'>
                        <div className='w-full md:w-auto'>
                            ...
                            >
                                <span>Employee Salary Print</span>
                                <span>
                                    <TfiPrinter />
                                </span>
                            </ButtonOne>
